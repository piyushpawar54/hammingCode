...
class HuffmanCoding:
    ...
    def __buildHeap(self,freq_dict):
        for key in freq_dict:
            ...
            binary_tree_node = BinaryTreeNode(key,frequncy)
